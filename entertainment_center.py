...
monsters_inc = media.Movie("Monsters, Inc.",
                           "Monsters realize they don't need to scare kids anymore",
...
the_phantom_menace = media.Movie("The Phantom Menace",
                                 "A boy decides to leave a lucrative racing career to become a Jedi",
...
# Calling the function to open up the webpage to show my fave movies with their trailers
